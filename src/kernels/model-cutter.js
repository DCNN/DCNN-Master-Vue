export default {
   ...
   * @param {Array} tensorSize: [batch_size, height, width, channel]
   ...
   */
  cutterTensor1D: function (tensor1D, tensorSize, fromHeight, toHeight) {
    let [ batch_size, height, width, channel ] = tensorSize
